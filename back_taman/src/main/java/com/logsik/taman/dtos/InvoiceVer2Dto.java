...
import com.logsik.taman.enums.VerifyReportStatus;

public class InvoiceVer2Dto implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long id;
	private Long projectDetailId;
	private VerifyReportStatus verifyReportStatus;
	...
	private List<UploadFileResponse> verifyUploadFile = new ArrayList<>();
	...
	public VerifyReportStatus getVerifyReportStatus() {
		return verifyReportStatus;
	}

	public void setVerifyReportStatus(VerifyReportStatus verifyReportStatus) {
		this.verifyReportStatus = verifyReportStatus;
	}
	...
	public List<UploadFileResponse> getVerifyUploadFile() {
		return verifyUploadFile;
	}

	public void setVerifyUploadFile(List<UploadFileResponse> verifyUploadFile) {
		this.verifyUploadFile = verifyUploadFile;
	}
