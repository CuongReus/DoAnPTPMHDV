...
const selector = formValueSelector('ModalSetLabourOTBreach');
...
const mapDispatchToProps = dispatch => ({
    ...
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "ModalSetLabourOTBreach", field: fieldName },
            payload: value,
            type: "@@redux-form/CHANGE"
        })
});
class ModalSetLabourOTBreach extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listAllProjects: [],
    ...
    componentWillMount() {
        const { loadLabourAttendance, labourDto, updateField, currentUser,isOvertime } = this.props;
        this.getListProject();
        this.getListLabour();
    ...
    render() {
        ...
        const { handleSubmit, submitting, title, invalid,lastedUpdateUserId,
            createdUserId, currentUser, initialValues, labourDto, endDatetime, startDatetime, startOvertime, endOvertime } = this.props;
                            ...
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                {  /* Just Show Infomation */}
                                    <div style={{ color: 'blue' }}>
                                        <Field disabled={true} name="overtimeStatus" label="Trạng Thái Tăng Ca" options={optionOvertimeStatus} component={RenderSelect}></Field>
                                        <Field disabled={true} name="startOvertime" label="Giờ Bắt Đầu Tăng Ca" placeholder="00:00" component={RenderTimeWrapper} ></Field>
                                        <Field disabled={true}  name="endOvertime" label="Giờ Kết Thúc Tăng Ca" placeholder="00:00" component={RenderTimeWrapper}></Field>
                                        <Field disabled={true} name="totalOvertime" label="Tổng Giờ Tăng Ca" component={RenderNumberInput}></Field>
                                    </div>
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(
        reduxForm({
            form: 'ModalSetLabourOTBreach',
            destroyOnUnmount: true,
            enableReinitialize: true,
            validate
        })(ModalSetLabourOTBreach)));
