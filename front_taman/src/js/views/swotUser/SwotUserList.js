...
import ModalSwotUser from './ModalSwotUser';
...
class SwotUserList extends React.Component {
    constructor() {
        super();
        this.state = {
            listSwotUser: null,
            isSwotUserListModalShown: false,
        }
        this.handleShowmodal = this.handleShowmodal.bind(this);
        this.handleHidemodal = () => {
            this.setState({ isSwotUserModalShown: false });
            this.updateListSwotUser();
        }
    };
    ...
    //Delete SwotUser Function
    deleteSwotUser(id, name) {
                        ...
                        <ul className="icons-list">
                            <li className="dropdown">
                                ...
                                <SecuredComponent allowedPermission="admin.department.update">
                                    ...
                                    <li><a onClick={() => this.deleteSwotUser(item.id, item.name)}><i className="icon-cross2"></i>Xóa</a></li>
                                    </SecuredComponent>
                                </ul>
                            </li>
                        </ul>
                ...
                <div className="content">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            {this.state.isSwotUserModalShown ? <ModalSwotUser title="Danh Mục SWOT" idSwotUser={this.state.idSwotUser} show={this.state.isSwotUserModalShown} onHide={this.handleHidemodal} /> : null}
                                ...
                                <table className="table table-togglable table-hover">
                                    <thead>
                                        <tr className="bg-teal">
                                            ...
                                            <th data-toggle="true">Số năm kinh nghiệm</th>
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(SwotUserList));