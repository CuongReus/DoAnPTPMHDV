...
const selector = formValueSelector('ModalOtherCost');
...
const mapDispatchToProps = dispatch => ({
    ...
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "ModalOtherCost", field: fieldName },
            payload: value,
...
class ModalOtherCost extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listAllUsers: [],
    ...
    render() {
        ...
        dataPersonels.map(item => {
             if(SecurityUtils.hasPermission(item, "admin.projectCostApproval.otherAllowApproval")){
                    ...
                    <Modal.Body>
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                <Field disabled={SecurityUtils.hasPermission(currentUser, "admin.projectCostApproval.otherAllowApproval")? false:true} name="status" label="Trạng Thái" placeholder="Chọn trạng thái..." options={optionsStatus} component={RenderSelect}></Field>
