...
const selector = formValueSelector('ModalConstructionTeamCost');
...
const mapDispatchToProps = dispatch => ({
    loadProjectCost: (payload) =>
        ...
        dispatch({
            meta: { form: "ModalConstructionTeamCost", field: fieldName },
            payload: value,
...
class ModalConstructionTeamCost extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listAllUsers:[],
    ...
    componentWillMount() {
        const { loadProjectCost, loadProjectDetailDto, projectDetailDto,updateField,lotNumber} = this.props;
    ...
    render() {
        ...
        dataPersonels.map(item => {
            // if(SecurityUtils.hasPermission(item, "admin.holiday.approvalLetter")){
                  if(SecurityUtils.hasPermission(item,  "admin.projectCostApproval.constructionTeamAllowApproval")){
                    ...
                    <Modal.Body>
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                <Field name="title" label="Tên Đội Thi Công" placeholder="Nhập tên đội thi công.." component={RenderInputWithDiv}></Field>
                                ...
                                <Field name="projectCostFile" label="File Thanh Toán Đội Thi Công" component={ListFile} modalUrl="/uploadProjectCostFile" ></Field>
                               ...
                               <Field disabled={SecurityUtils.hasPermission(currentUser,  "admin.projectCostApproval.constructionTeamAllowApproval",)? false:true} name="status" label="Trạng Thái" placeholder="Chọn trạng thái..." options={optionsStatus} component={RenderSelect}></Field>
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(
        reduxForm({
            form: 'ModalConstructionTeamCost',
            destroyOnUnmount: true,
            enableReinitialize: true,
            validate
        })(ModalConstructionTeamCost)));
