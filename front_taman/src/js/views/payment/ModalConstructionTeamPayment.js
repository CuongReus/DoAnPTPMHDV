...
const selector = formValueSelector('ModalConstructionTeamPayment');
...
const mapDispatchToProps = dispatch => ({
    ...
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "ModalConstructionTeamPayment", field: fieldName },
            payload: value,
...
class ModalConstructionTeamPayment extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listAllUsers: [],
    ...
    render() {
        ...
        const { handleSubmit, isApprovalScreen, submitting, projectCostDto, dataProjectCostPayment, totalPercentPaidFromProps, title, projectDetailDto, status, invalid, createdUserId, currentUser, lastedUpdateUserId, initialValues,
            lastedLot
        } = this.props;
        ...
        dataPersonels.map(item => {
             if(SecurityUtils.hasPermission(item, "admin.projectPaymentApproval.constructionTeamAllowApproval")){
                        ...
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                <Field name="approvalById" label="Duyệt Bởi" placeholder="Chọn người duyệt..." options={optionsApprovalBy} component={RenderSelect}></Field>
                                 <Field disabled={SecurityUtils.hasPermission(currentUser, "admin.projectPaymentApproval.constructionTeamAllowApproval")? false : true} name="status" label="Trạng Thái Thanh Toán" placeholder="Chọn Trạng Thái Thanh Toán"  options={optionsStatus} component={RenderSelect}></Field>
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(
        reduxForm({
            form: 'ModalConstructionTeamPayment',
            destroyOnUnmount: true,
            enableReinitialize: true,
            validate
        })(ModalConstructionTeamPayment)));
