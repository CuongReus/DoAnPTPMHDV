...
const selector = formValueSelector('ModalOtherPayment');
...
const mapDispatchToProps = dispatch => ({
    ...
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "ModalOtherPayment", field: fieldName },
            payload: value,
...
class ModalOtherPayment extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listAllUsers: [],
    ...
    render() {
        ...
        dataPersonels.map(item => {
            // if(SecurityUtils.hasPermission(item, "admin.holiday.approvalLetter")){
             if(SecurityUtils.hasPermission(item, "admin.projectPaymentApproval.otherAllowApproval")){
                        ...
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                <Field name="approvalById" label="Duyệt Bởi" placeholder="Chọn người duyệt..." options={optionsApprovalBy} component={RenderSelect}></Field>
                                 <Field disabled={SecurityUtils.hasPermission(currentUser, "admin.projectPaymentApproval.otherAllowApproval")? false : true} name="status" label="Trạng Thái Thanh Toán" placeholder="Chọn Trạng Thái Thanh Toán"  options={optionsStatus} component={RenderSelect}></Field>
